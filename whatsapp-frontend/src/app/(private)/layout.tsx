...
export default function PrivateLayout({ children }: { children: React.ReactNode }) {
  ...
  // Diccionario de nombres de página
  const pageTitles: Record<string, string> = {
    ...
    "/groups": "Grupos",
    "/groupsIntegration": "Integración Grupos",
  ...
  // Extraer título en base al pathname
  const currentTitle =
    pageTitles[pathname as keyof typeof pageTitles] || "Página";
        ...
        >
          <header className="bg-white border-b border-gray-200 px-4 py-3 flex items-center sticky top-0 z-30 shrink-0">
            ...
            <h1 className="text-lg font-semibold text-gray-900">
              {isMobile ? "WhatsApp Web" : currentTitle}
            </h1>
          </header>
